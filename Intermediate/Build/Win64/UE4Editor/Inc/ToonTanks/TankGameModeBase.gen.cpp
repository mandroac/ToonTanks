...
// End Cross Module References
	...
	void ATankGameModeBase::GameOver(bool bPlayerWon)
	{
	...
	struct Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics
	{
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bPlayerWon;
	...
	void Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_bPlayerWon_SetBit(void* Obj)
	{
		((TankGameModeBase_eventGameOver_Parms*)Obj)->bPlayerWon = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_bPlayerWon = { "bPlayerWon", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(TankGameModeBase_eventGameOver_Parms), &Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_bPlayerWon_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::NewProp_bPlayerWon,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATankGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATankGameModeBase_GameOver, "GameOver" }, // 1889337825
	...
	IMPLEMENT_CLASS(ATankGameModeBase, 1028928584);
